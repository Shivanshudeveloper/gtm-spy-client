...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class CommonClass {
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      fboWidth: any = null; fboHeight: any = null;
      time = 0; delta = 0;
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      container: any = null; renderer: any = null; clock: any = null;
    ...
    class MouseClass {
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      timer: any = null; container: any = null; docTarget: any = null; listenerTarget: any = null;
      ...
      update() {
        if (this.takeoverActive) {
          ...
          if (t >= 1) {
            ...
            this.coords.copy(this.takeoverTo); this.coords_old.copy(this.coords); this.diff.set(0, 0);
          } else {
            const k = t * t * (3 - 2 * t);
    ...
    class AutoDriver {
      ...
      rampDurationMs: number; active = false;
    ...
    class Advection extends ShaderPass {
      ...
      init() {
        ...
        boundaryG.setAttribute('position', new THREE.BufferAttribute(vb, 3));
    ...
    class ExternalForce extends ShaderPass {
      ...
      update(props: any) {
        ...
        u.force.value.set(forceX, forceY); u.center.value.set(cx, cy); u.scale.value.set(props.cursor_size, props.cursor_size);
        super.update();
      }
    }
    ...
    class Viscous extends ShaderPass {
      ...
      update({ viscous, iterations, dt }: any) {
        ...
        for (let i = 0; i < iterations; i++) {
          ...
          this.uniforms.velocity_new.value = fbo_in.texture; this.props.output = fbo_out; this.uniforms.dt.value = dt; super.update();
        }
        return fbo_out;
      }
    }
    ...
    class WebGLManager {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      props: any; output: any; autoDriver: any; lastUserInteraction: number; running = false;
      _loop: () => void; _resize: () => void; _onVisibility: () => void;
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      constructor(props: any) {
        this.props = props;
