      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-20">
          ...
          <div className="relative space-y-8">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary to-primary-dim flex items-center justify-center text-on-primary-fixed font-headline text-3xl font-black shadow-neon">1</div>
          ...
          {/* Step 2 */}
          <div className="relative space-y-8">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary to-primary-dim flex items-center justify-center text-on-primary-fixed font-headline text-3xl font-black shadow-neon">2</div>
            <div className="space-y-4">
          ...
          {/* Step 3 */}
          <div className="relative space-y-8">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary to-primary-dim flex items-center justify-center text-on-primary-fixed font-headline text-3xl font-black shadow-neon">3</div>
            <div className="space-y-4">
