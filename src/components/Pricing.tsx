...
export default function Pricing() {
  ...
  return (
    <section id="pricing-section" className="py-20 md:py-40 bg-surface relative overflow-hidden">
      {/* Ambient Glow */}
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 relative z-10">
        <div className="text-center mb-20 space-y-6">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-7xl font-black font-headline tracking-tight-display">Simple Pay-As-You-Snipe</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          {/* Pricing Calculator */}
          <div className="glass-panel p-6 sm:p-10 md:p-12 rounded-3xl space-y-8 md:space-y-10 relative overflow-hidden group">
            ...
            <div className="bg-surface-container-highest rounded-2xl border border-white/5 p-6 space-y-6">
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-4xl md:text-5xl font-black text-white tabular-nums">{credits}</span>
            ...
            <div className="border-t border-white/5 pt-8 space-y-2">
              <div className="flex justify-between items-baseline">
                ...
                <div className="flex items-baseline gap-1">
                  ...
                  <span className="text-5xl md:text-6xl font-black text-white tabular-nums">{total}</span>
                </div>
              </div>
          ...
          <div className="space-y-8 md:space-y-12">
            {[
              ...
              <div key={i} className="flex gap-5 md:gap-8 group">
                <div className="w-14 h-14 md:w-16 md:h-16 shrink-0 rounded-2xl bg-surface-container-high border border-white/5 flex items-center justify-center group-hover:bg-primary transition-all duration-500 group-hover:rotate-6 transform">
                  <span className="material-symbols-outlined text-2xl md:text-3xl text-primary group-hover:text-black">{prop.icon}</span>
                </div>
